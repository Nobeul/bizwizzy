...
[Get Postman Collection](https://bizwizzy.com/ulti1/public/docs/collection.json)
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "https://bizwizzy.com/ulti1/public/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"et","ip_address":"et","latitude":"nihil","longitude":"tempore"}'
...
```bash
curl -X POST \
    "https://bizwizzy.com/ulti1/public/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"et","latitude":"voluptas","longitude":"placeat"}'
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/holidays?location_id=possimus&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=at&follow_up_type=debitis&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/crm/follow-ups"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X PUT \
    "https://bizwizzy.com/ulti1/public/connector/api/crm/follow-ups/20" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"aut","schedule_type":"fuga","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","followup_additional_info":"['call duration' => '1 hour']","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","allow_notification":true}'
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=reiciendis&biz_name=ipsa&mobile_num=1&contact_id=voluptatem&order_by=occaecati&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "https://bizwizzy.com/ulti1/public/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"harum","mobile_name":"omnis","call_type":"call","start_time":"autem","end_time":"fugiat","duration":"et"}]}'
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=itaque&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":2,"initial_amount":8905.760000000000218278728425502777099609375,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":0.683100000000000040500935938325710594654083251953125,"total_card_slips":8,"total_cheques":18,"closing_note":"quisquam","transaction_ids":"1,2,3"}'
...
let body = {
    "location_id": 2,
    "initial_amount": 8905.760000000000218278728425502777099609375,
    "created_at": "2020-5-7 15:20:22",
    "closed_at": "2020-5-7 15:20:22",
    "status": "close",
    "closing_amount": 0.683100000000000040500935938325710594654083251953125,
    "total_card_slips": 8,
    "total_cheques": 18,
    "closing_note": "quisquam",
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/contactapi?type=est&name=perferendis&biz_name=quam&mobile_num=15&contact_id=velit&order_by=autem&direction=dolorem&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"rem","prefix":"minima","first_name":"aspernatur","middle_name":"veritatis","last_name":"ut","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"alias","address_line_2":"labore","city":"deserunt","state":"eveniet","country":"et","zip_code":"fugiat","customer_group_id":"qui","contact_id":"occaecati","dob":"2000-06-13","custom_field1":"optio","custom_field2":"sequi","custom_field3":"quibusdam","custom_field4":"magnam","email":"animi","shipping_address":"vel","position":"repellat","opening_balance":0,"source_id":8,"life_stage_id":6,"assigned_to":[]}'
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"vel","prefix":"voluptatum","first_name":"enim","middle_name":"sit","last_name":"aspernatur","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"minus","address_line_2":"eos","city":"nemo","state":"dolor","country":"nemo","zip_code":"aut","customer_group_id":"est","contact_id":"nobis","dob":"2000-06-13","custom_field1":"perspiciatis","custom_field2":"alias","custom_field3":"quasi","custom_field4":"aut","email":"aut","shipping_address":"nisi","position":"tenetur","opening_balance":10.300000000000000710542735760100185871124267578125,"source_id":17,"life_stage_id":17,"assigned_to":[]}'
...
let body = {
    ...
    "contact_id": "nobis",
    "dob": "2000-06-13",
    "custom_field1": "perspiciatis",
    "custom_field2": "alias",
    "custom_field3": "quasi",
    "custom_field4": "aut",
    "email": "aut",
    "shipping_address": "nisi",
    "position": "tenetur",
...
```bash
curl -X POST \
    "https://bizwizzy.com/ulti1/public/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.1299999999999954525264911353588104248046875,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":4,"card_number":"itaque","card_holder_name":"est","card_transaction_number":"sit","card_type":"labore","card_month":"est","card_year":"velit","card_security":"sunt","transaction_no_1":"et","transaction_no_2":"soluta","transaction_no_3":"corrupti","cheque_number":"ut","bank_account_number":"quos","note":"aut"}'
...
let body = {
    ...
    "card_security": "sunt",
    "transaction_no_1": "et",
    "transaction_no_2": "soluta",
    "transaction_no_3": "corrupti",
    "cheque_number": "ut",
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/expense?location_id=suscipit&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=quo&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":14,"final_total":11431,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":3,"expense_for":3,"contact_id":14,"additional_notes":"ad","is_refund":0,"is_recurring":0,"recur_interval":5,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"accusamus","recur_repetitions":5,"payment":[{"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":13,"card_number":"commodi","card_holder_name":"totam","card_transaction_number":"rerum","card_type":"vel","card_month":"voluptatem","card_year":"quisquam","card_security":"consequatur","transaction_no_1":"voluptas","transaction_no_2":"in","transaction_no_3":"aut","note":"praesentium","cheque_number":"facere"}]}'
    ...
    "payment": [
        {
            ...
            "account_id": 13,
            "card_number": "commodi",
            "card_holder_name": "totam",
            "card_transaction_number": "rerum",
            "card_type": "vel",
            "card_month": "voluptatem",
            "card_year": "quisquam",
            "card_security": "consequatur",
            "transaction_no_1": "voluptas",
            "transaction_no_2": "in",
            "transaction_no_3": "aut",
            "note": "praesentium",
            "cheque_number": "facere"
        }
    ]
}
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "https://bizwizzy.com/ulti1/public/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":13633.899999999999636202119290828704833984375,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":8,"expense_for":6,"contact_id":4,"additional_notes":"maiores","is_recurring":0,"recur_interval":10,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"voluptates","recur_repetitions":7,"payment":[]}'
...
let body = {
    "final_total": 13633.899999999999636202119290828704833984375,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 8,
    "expense_for": 6,
    "contact_id": 4,
    "additional_notes": "maiores",
    "is_recurring": 0,
    "recur_interval": 10,
    "recur_interval_type": "months",
    "subscription_repeat_on": 15,
    "subscription_no": "voluptates",
    "recur_repetitions": 7,
    "payment": []
}
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/expense-refund?location_id=quisquam&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=eius&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/expense-refund"
);

let params = {
    "location_id": "quisquam",
    "payment_status": "paid",
    "start_date": "2018-06-25",
    "end_date": "2018-06-25",
    "expense_for": "eius",
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/product?order_by=qui&order_direction=et&brand_id=qui&category_id=mollitia&sub_category_id=rerum&location_id=facere&selling_price_group=reiciendis&name=sit&sku=autem&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/product"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/product/1?selling_price_group=nulla" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/product/1"
);

let params = {
    "selling_price_group": "nulla",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/variation/2?product_id=corporis&location_id=ex&brand_id=vero&category_id=qui&sub_category_id=mollitia&not_for_selling=neque&name=rerum&sku=facere&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/variation/2"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/sell?location_id=sed&contact_id=sapiente&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=ipsum&service_staff_id=nobis&shipping_status=ordered&only_subscriptions=sequi&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/sell"
);
...
let params = {
    ...
    "end_date": "2018-06-25",
    "user_id": "ipsum",
    "service_staff_id": "nobis",
    "shipping_status": "ordered",
    "only_subscriptions": "sequi",
    "order_by_date": "desc",
    "per_page": "10",
};
Object.keys(params)
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":4,"contact_id":9,"transaction_date":"2020-07-22 15:48:29","invoice_no":"voluptas","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":17,"discount_amount":10,"discount_type":"fixed","sale_note":"illum","staff_note":"sit","commission_agent":2,"shipping_details":"Express Delivery","shipping_address":"dolores","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":2,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":6,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"perspiciatis","recur_repetitions":17,"rp_redeemed":17,"rp_redeemed_amount":13.5,"types_of_service_id":8,"service_custom_field_1":"qui","service_custom_field_2":"recusandae","service_custom_field_3":"et","service_custom_field_4":"voluptas","service_custom_field_5":"non","service_custom_field_6":"qui","round_off_amount":52059.014104226997005753219127655029296875,"table_id":5,"service_staff_id":10,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":6,"note":"dolorem"}],"payments":[{"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":14,"card_number":"amet","card_holder_name":"sunt","card_transaction_number":"repudiandae","card_type":"fugiat","card_month":"sint","card_year":"voluptatum","card_security":"rerum","transaction_no_1":"recusandae","transaction_no_2":"qui","transaction_no_3":"est","bank_account_number":"expedita","note":"perspiciatis","cheque_number":"facilis"}]}]}'
    ...
    "sells": [
        {
            ...
            "recur_interval_type": "months",
            "subscription_repeat_on": 15,
            "subscription_no": "perspiciatis",
            "recur_repetitions": 17,
            "rp_redeemed": 17,
            "rp_redeemed_amount": 13.5,
            "types_of_service_id": 8,
            "service_custom_field_1": "qui",
            "service_custom_field_2": "recusandae",
            "service_custom_field_3": "et",
            "service_custom_field_4": "voluptas",
            "service_custom_field_5": "non",
            "service_custom_field_6": "qui",
            "round_off_amount": 52059.014104226997005753219127655029296875,
            "table_id": 5,
            "service_staff_id": 10,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "card_security": "rerum",
                    "transaction_no_1": "recusandae",
                    "transaction_no_2": "qui",
                    "transaction_no_3": "est",
                    "bank_account_number": "expedita",
                    "note": "perspiciatis",
                    "cheque_number": "facilis"
                }
            ]
        }
    ]
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/sell/55"
);
...
```bash
curl -X PUT \
    "https://bizwizzy.com/ulti1/public/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":5,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":3,"discount_amount":10,"discount_type":"fixed","sale_note":"voluptatum","staff_note":"repudiandae","sells":[{"is_suspend":false}],"commission_agent":3,"shipping_details":"Express Delivery","shipping_address":"velit","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":2,"pay_term_number":12,"pay_term_type":"months","is_recurring":0,"recur_interval":19,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"consequuntur","recur_repetitions":17,"rp_redeemed":6,"rp_redeemed_amount":13.5,"types_of_service_id":7,"service_custom_field_1":"libero","service_custom_field_2":"laudantium","service_custom_field_3":"accusantium","service_custom_field_4":"eaque","service_custom_field_5":"et","service_custom_field_6":"expedita","round_off_amount":2893743.83660000003874301910400390625,"table_id":9,"service_staff_id":17,"change_return":0,"change_return_id":5,"products":[{"sell_line_id":18,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":9,"discount_amount":0,"discount_type":"percentage","sub_unit_id":10,"note":"illum"}],"payments":[{"payment_id":16,"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":13,"card_number":"deleniti","card_holder_name":"recusandae","card_transaction_number":"quis","card_type":"illo","card_month":"adipisci","card_year":"et","card_security":"cum","transaction_no_1":"impedit","transaction_no_2":"dolor","transaction_no_3":"maiores","note":"beatae","cheque_number":"alias","bank_account_number":"laborum"}]}'
...
let body = {
    ...
    "discount_amount": 10,
    "discount_type": "fixed",
    "sale_note": "voluptatum",
    "staff_note": "repudiandae",
    "sells": [
        {
            "is_suspend": false
        }
    ...
    "subscription_no": "consequuntur",
    "recur_repetitions": 17,
    "rp_redeemed": 6,
    "rp_redeemed_amount": 13.5,
    "types_of_service_id": 7,
    "service_custom_field_1": "libero",
    "service_custom_field_2": "laudantium",
    "service_custom_field_3": "accusantium",
    "service_custom_field_4": "eaque",
    "service_custom_field_5": "et",
    "service_custom_field_6": "expedita",
    "round_off_amount": 2893743.83660000003874301910400390625,
    "table_id": 9,
    "service_staff_id": 17,
    "change_return": 0,
    "change_return_id": 5,
    ...
    "payments": [
        {
            ...
            "method": "cash",
            "account_id": 13,
            "card_number": "deleniti",
            "card_holder_name": "recusandae",
            "card_transaction_number": "quis",
            "card_type": "illo",
            "card_month": "adipisci",
            "card_year": "et",
            "card_security": "cum",
            "transaction_no_1": "impedit",
            "transaction_no_2": "dolor",
            "transaction_no_3": "maiores",
            "note": "beatae",
            "cheque_number": "alias",
...
```bash
curl -X DELETE \
    "https://bizwizzy.com/ulti1/public/connector/api/sell/voluptates" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "https://bizwizzy.com/ulti1/public/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":3,"transaction_date":"2020-5-7 15:20:22","invoice_no":"eum","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":6,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "https://bizwizzy.com/ulti1/public/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":6,"shipping_status":"ordered","delivered_to":"dolores"}'
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/table?location_id=suscipit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/table"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/taxonomy?type=placeat" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/user/loggedin"
);
...
```bash
curl -X POST \
    "https://bizwizzy.com/ulti1/public/connector/api/user-registration" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"consequatur","first_name":"doloribus","last_name":"aut","email":"necessitatibus","is_active":"accusantium","user_type":"hic","crm_contact_id":16,"allow_login":true,"username":"minima","password":"voluptas","role":20,"access_all_locations":false,"location_permissions":[],"cmmsn_percent":"illo","max_sales_discount_percent":"labore","selected_contacts":true,"selected_contact_ids":[],"dob":"amet","gender":"non","marital_status":"vitae","blood_group":"dolor","contact_number":"ut","alt_number":"sit","family_number":"culpa","fb_link":"numquam","twitter_link":"aut","social_media_1":"nostrum","social_media_2":"incidunt","custom_field_1":"recusandae","custom_field_2":"neque","custom_field_3":"et","custom_field_4":"sunt","guardian_name":"maxime","id_proof_name":"voluptates","id_proof_number":"minima","permanent_address":"qui","current_address":"quos","bank_details":[{"account_holder_name":"omnis","account_number":"doloremque","bank_name":"aliquam","bank_code":"tempora","branch":"aut","tax_payer_id":"est"}]}'
...
let body = {
    ...
    "cmmsn_percent": "illo",
    "max_sales_discount_percent": "labore",
    "selected_contacts": true,
    "selected_contact_ids": [],
    "dob": "amet",
    "gender": "non",
    "marital_status": "vitae",
    "blood_group": "dolor",
    "contact_number": "ut",
    "alt_number": "sit",
    "family_number": "culpa",
    "fb_link": "numquam",
    "twitter_link": "aut",
    "social_media_1": "nostrum",
    "social_media_2": "incidunt",
    "custom_field_1": "recusandae",
    "custom_field_2": "neque",
    "custom_field_3": "et",
    "custom_field_4": "sunt",
    "guardian_name": "maxime",
    "id_proof_name": "voluptates",
    "id_proof_number": "minima",
    "permanent_address": "qui",
    "current_address": "quos",
    "bank_details": [
        {
            "account_holder_name": "omnis",
            "account_number": "doloremque",
            "bank_name": "aliquam",
            "bank_code": "tempora",
            "branch": "aut",
            "tax_payer_id": "est"
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/user?service_staff=velit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/user"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/user/1"
);
...
```bash
curl -X POST \
    "https://bizwizzy.com/ulti1/public/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"qui","new_password":"et"}'
...
```bash
curl -X POST \
    "https://bizwizzy.com/ulti1/public/connector/api/forget-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"email":"voluptatum"}'
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/profit-loss-report?location_id=et&start_date=2018-06-25&end_date=2018-06-25&user_id=sunt" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "https://bizwizzy.com/ulti1/public/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://bizwizzy.com/ulti1/public/connector/api/notifications"
);
