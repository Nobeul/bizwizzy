$(document).ready(function() {
    ...
    $(document).on('click', 'button.delete_assigned_product_button', function() {
        swal({
            title: LANG.sure,
            text: 'This product would be removed from assigned list',
            icon: 'warning',
            buttons: true,
            dangerMode: true,
        }).then(willDelete => {
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if (result.success == true) {
                            toastr.success(result.msg);
                            product_link_table.ajax.reload();
                        } else {
                            toastr.error(result.msg);
                        }
                    },
...
function updateProfitLoss(start = null, end = null, location_id = null, selector = null) {
    ...
    var vehicle_id = $('#pnl_vehicle_no').val();
    var data = { start_date: start, end_date: end, location_id: location_id, vehicle_id: vehicle_id };
