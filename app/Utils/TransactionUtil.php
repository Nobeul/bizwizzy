...
class TransactionUtil extends Util
{
    ...
    public function getReceiptDetails($transaction_id, $location_id, $invoice_layout, $business_details, $location_details, $receipt_printer_type, $product_sell_lines = [])
    {
        ...
        $output['show_vat'] = $il->common_settings['show_vat'] ?? false;
        $output['cash_or_credit_sale'] = $transaction->payment_status == 'paid' ? "CASH SALE" : "INVOICE";
     ...
     * @return array
     */
    public function getPurchaseTotals($business_id, $start_date = null, $end_date = null, $location_id = null, $user_id = null, $vehicle_id = null)
    {
     ...
     * @return array
     */
    public function getSellTotals($business_id, $start_date = null, $end_date = null, $location_id = null, $created_by = null, $vehicle_id = null)
    {
    ...
    */
     ...
     * @return float
     */
    public function getOpeningClosingStock($business_id, $date, $location_id, $is_opening = false, $by_sale_price = false, $filters = [], $vehicle_id = null)
    {
        ...
        if (! empty($vehicle_id)) {
            $query->where('purchase.vehicle_id', $vehicle_id);
        }
    ...
    */
    ...
    public function getGrossProfit($business_id, $start_date = null, $end_date = null, $location_id = null, $user_id = null, $vehicle_id = null)
    {
        ...
        $query->join('variations as V', 'transaction_sell_lines.variation_id', '=', 'V.id')
                ...
                ->addSelect(DB::raw('SUM((transaction_sell_lines.unit_price_inc_tax - V.dpp_inc_tax) * (transaction_sell_lines.quantity - transaction_sell_lines.quantity_returned)) as gross_profit'))
                ->groupBy('V.id');
        ...
        $gross_profit = 0;
        foreach ($gross_profit_obj as $obj) {
    ...
    */
    ...
    public function getProfitLossDetails($business_id, $location_id, $start_date, $end_date, $user_id = null, $vehicle_id = null)
    {
        ...
        //Get Opening stock
        $opening_stock = $this->getOpeningClosingStock($business_id, $day_before_start_date, $location_id, true, false, $filters, $vehicle_id);
        ...
        if (! empty($vehicle_id)) {
            $sales_by_subtype = $sales_by_subtype->where('transactions.vehicle_id', $vehicle_id);
        }
    ...
    public function updateExpense($request, $id, $business_id, $format_data = true)
    {
        ...
        $transaction_data['vehicle_id'] = ! empty($request->input('vehicle_id')) ? $request->input('vehicle_id') : null;
