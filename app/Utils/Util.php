...
class Util
{
    ...
    private function getLedgerData($contact_id, $start = null, $end = null, $format = 'format_1', $location_id = null, $line_details = false)
    {
        ...
        foreach ($transactions as $transaction) {
            ...
            $temp_array = [
                ...
                'invoice_no'=> $transaction->sales_order, 
                'location' => $transaction->location->name ?? '',
     ...
     */
    private function __transactionQuery($contact_id, $start = null, $end = null, $location_id = null)
    {
        $business_id = request()->session()->get('user.business_id');
     ...
     */
    private function __paymentQuery($contact_id, $start = null, $end = null, $location_id = null)
    {
        $business_id = request()->session()->get('user.business_id');
    ...
    {
        $transactions = $this->getLedgerData($contact_id);
        return $transactions['balance_due']-$transactions["ledger_discount"];
