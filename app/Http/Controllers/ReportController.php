...
class ReportController extends Controller
{
    ...
    public function getProfitLoss(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $data = $this->transactionUtil->getProfitLossDetails($business_id, $location_id, $start_date, $end_date, null, $vehicle_id);
        ...
        return view('report.profit_loss', compact('business_locations', 'vehicles', 'pos_settings'));
    }
    ...
    public function getExpenseReport(Request $request)
    {
        ...
        return view('report.expense_report')
                    ->with(compact('chart', 'categories', 'business_locations', 'expenses', 'vehicles', 'pos_settings'));
    }
