    ...
    */
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($expenses)
                ...
                ->addColumn('vehicle_reg_no', function($row) {
                    $reg_no = ' &nbsp;<small class="label bg-gray">' . $row->license_plate . '</small>';
    ...
    public function create()
    {
        ...
        return view('expense.create')
            ->with(compact('expense_categories', 'business_locations', 'users', 'taxes', 'payment_line', 'payment_types', 'accounts', 'bl_attributes', 'contacts', 'vehicles', 'pos_settings'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('expense.edit')
            ->with(compact('expense', 'expense_categories', 'business_locations', 'users', 'taxes', 'contacts', 'sub_categories', 'vehicles', 'pos_settings'));
    }
