<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title">{{ __('Edit driver commission') }}</h4>
    </div>
      ...
      <div class="col-md-6">
        <div class="form-group">
          {!! Form::label('cmmsn_percent', __('Commission Percentage(%)') . ':') !!}
            {!! Form::text('cmmsn_percent', @num_format($user->cmmsn_percent), ['class' => 'form-control input_number', 'placeholder' => __('Commission Percentage(%)'), 'required' ]); !!}
        </div>
      </div>
