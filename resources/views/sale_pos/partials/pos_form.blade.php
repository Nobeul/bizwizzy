	...
	<div class="col-md-8">
		<div class="form-group">
			<div class="input-group">
				...
				{!! Form::text('search_product', null, ['class' => 'form-control mousetrap', 'id' => 'search_product', 'placeholder' => __('Enter Service Name'),
	...
	<div class="col-sm-4">
    	<div class="form-group">
    		<div class="input-group">
    			...
    			{!! Form::text('customer_pin', null, ['class' => 'form-control', 'placeholder' => __('Customer PIN')]); !!}
    		</div>
    	</div>
    </div>
