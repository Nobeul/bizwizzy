            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'vehicles.view', in_array('vehicles.view', $role_permissions), [
                                    'class' => 'input-icheck',
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'vehicles.create', in_array('vehicles.create', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Add Vehicles') }}
                            </label>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'vehicles.update', in_array('vehicles.update', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Edit Vehicles') }}
                            </label>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'vehicles.delete', in_array('vehicles.delete', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Delete Vehicles') }}
                            </label>
                        </div>
