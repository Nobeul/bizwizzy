                ...
                <div class="row check_group">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'purchase_requisition.create', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.create_purchase_requisition') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'purchase_requisition.delete', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.delete_purchase_requisition') }}
                                </label>
                            </div>
                        </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'deselect_product', false, ['class' => 'input-icheck']) !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'pos.view_walking_customer_sale', false, ['class' => 'input-icheck']) !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'pos.view_sale_other_than_walking_customer', false, ['class' => 'input-icheck']) !!}
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'deselected_product_report', false, ['class' => 'input-icheck']) !!} {{ __('Voided Products Report') }}
                            </label>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'vehicles.view', false, [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Access all vehicles') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'vehicles.create', false, [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Add Vehicles') }}
                            </label>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'vehicles.update', false, [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Edit Vehicles') }}
                            </label>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'vehicles.delete', false, [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('Delete Vehicles') }}
                            </label>
                        </div>
